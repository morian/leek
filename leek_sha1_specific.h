#ifndef __LEEK_SHA1_SPECIFIC_H
# define __LEEK_SHA1_SPECIFIC_H
# include <stdint.h>
...
/* These files provide the correct macros and defines for each specific implementation. */
# if defined(__AVX2__)
